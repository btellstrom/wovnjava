...
public class HtmlConverterTest extends TestCase {
    ...
    public void testRemoveWovnSnippet() {
        String original = "<html><head><script src=\"//j.wovn.io/1\" data-wovnio=\"key=NCmbvk&amp;backend=true&amp;currentLang=en&amp;defaultLang=en&amp;urlPattern=path&amp;langCodeAliases={}&amp;version=0.3.6a\" data-wovnio-type=\"backend_without_api\" async></script></head><body></body></html>";
    ...
    public void testMixAllCase() {
        String original = "<html><head>" +
            "<script src=\"//j.wovn.io/1\" data-wovnio=\"key=NCmbvk&amp;backend=true&amp;currentLang=en&amp;defaultLang=en&amp;urlPattern=path&amp;langCodeAliases={}&amp;version=0.3.6a\" data-wovnio-type=\"backend_without_api\" async></script>" +
